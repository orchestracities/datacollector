...
public class OIDCAuthenticationUser implements Authentication.User {
  private final SSOPrincipal principal;
  private final String id;
  private volatile boolean valid;
  private long validationTime;

  public OIDCAuthenticationUser(final SSOPrincipal principal) {
  ...
  public boolean equals(Object obj) {
    boolean eq = false;
    if (obj != null && obj instanceof OIDCAuthenticationUser) {
      eq = id.equals(((OIDCAuthenticationUser) obj).id);
    }
    return eq;
  }
